...
import com.perez.udacity.popularmovies.data.api.MoviesApi;
...
import com.perez.udacity.popularmovies.utils.Lists;
...
import static com.perez.udacity.popularmovies.data.provider.MoviesContract.Movies;
...
final class MoviesRepositoryImpl implements MoviesRepository {
    ...
    public Observable<List<Movie>> discoverMovies(Sort sort, int page) {
        return mMoviesApi.moviePopular(sort, page)
